...
1. Terminate all running instances of veil_switches
	 ...
	 If you are running traffic_gen instances, you may want to kill them as well by using:
			"pkill -f traffic_gen"
...
4. If you get some permission errors while executing some of the *.sh files, you may want to run it as a root user to resolve it.
